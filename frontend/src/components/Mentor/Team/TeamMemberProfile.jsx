...
const TeamMemberProfile = ({ isOpen, onClose, member, mentorId, onDataChange }) => {
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="w-full md:w-1/3">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-center">{memberData?.name}</h3>
            ...
            <div className="w-full md:w-2/3 space-y-6">
              {memberData?.bio && (
                <div>
                  ...
                  <p className="text-gray-600">{memberData.bio}</p>
                </div>
              )}
              ...
              {member.responsibilities && member.responsibilities.length > 0 && (
                <div>
                  <h3 className="text-md font-medium text-gray-700 mb-2">Team Responsibilities</h3>
              ...
              {memberData?.projects && memberData.projects.length > 0 && (
                <div>
                  <h3 className="text-md font-medium text-gray-700 mb-2">Personal Projects</h3>
                  <div className="space-y-4">
  ...
  const renderFeedbackTab = () => (
    <div className="p-6">
      <div className="mb-6">
        <h3 className="text-md font-medium text-gray-700 mb-2">Provide Feedback</h3>
        <textarea
          value={feedback}
      ...
      <div>
        <h3 className="text-md font-medium text-gray-700 mb-2">Previous Feedback</h3>
        {feedbackList.length > 0 ? (
          ...
          <div className="text-center py-8 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-400">Be the first to provide feedback</p>
          </div>
        )}
      </div>
    </div>
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-indigo-50">
          <div className="flex items-center">
            <button 
              onClick={onClose}
              className="p-1 mr-3 rounded-full hover:bg-indigo-100"
            >
