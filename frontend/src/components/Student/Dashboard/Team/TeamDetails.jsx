    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        {activeTab === 'mentors' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-medium text-lg">Team Mentors</h3>
              <button 
                onClick={() => navigate(`/student/team/${teamId}/mentors`)}
                className="text-indigo-600 hover:text-indigo-800 flex items-center gap-1 text-sm"
              >
                <Shield size={16} />
                Manage Mentors
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      ...
                      {team.userStatus.isLeader && (
                        <button 
                          onClick={() => {
                            if (window.confirm('Are you sure you want to remove this mentor from your team?')) {
                              // Implement logic to remove mentor
                              axios.post(`http://localhost:4000/api/teams/${teamId}/mentors/remove`, {
                                mentorId: team.mentor.mentorId,
